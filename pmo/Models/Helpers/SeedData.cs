...
namespace Helpers
{
    public class SeedData
    {
        ...
        public static void Insert(EfContext _context)
        {
            //if (_context.SeedDataMigrationVersions.FirstOrDefault() == null)
            //{
                using (var transaction = _context.Database.BeginTransaction())
                {
                    //#region Add Version
                    //_context.SeedDataMigrationVersions.Add(new SeedDataMigrationVersion() { Id=1, Version = 1 });
                    //_context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.SeedDataMigrationVersions ON;");
                    //_context.SaveChanges();
                    //_context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.SeedDataMigrationVersions OFF");
                    //#endregion
                    #region Insert TagCategories
                    _context.TagCategories.AddRange(new List<TagCategory>() {
                    ...
                    new TagCategory { Id = 15, IsFixed = true, FriendlyName = "Deliverable Register", Key = "deliverable-register" },

                });
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.TagCategories ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.TagCategories OFF");
                    #endregion
                    ...
                    new Tag { Id = 214,  Name = "Zimbabwe", TagCategoryId = 2 },
                     ...
                     //Customers 
                        ...
                        new Tag { Id =  743  , Name ="dummy Data2", TagCategoryId =  14},
                         ...
                         //Stage 2
                        new Tag { Id =  744  , Name ="Design Concepts", TagCategoryId =  15},
                        //Stage 3
                        new Tag { Id =  745  , Name ="DMFEA", TagCategoryId =  15},
                        new Tag { Id =  746  , Name ="DVT Test Plan", TagCategoryId =  15},
                        new Tag { Id =  747  , Name ="Qual Test Plan", TagCategoryId =  15},
                        new Tag { Id =  748  , Name ="Design Review", TagCategoryId =  15},
                        new Tag { Id =  749  , Name ="PFMEA", TagCategoryId =  15},
                        new Tag { Id =  750  , Name ="ESH Checklist", TagCategoryId =  15},
                        new Tag { Id =  751  , Name ="Product Safety Analysis", TagCategoryId =  15},
                        new Tag { Id =  752  , Name ="Packaging Definition", TagCategoryId =  15},
                        new Tag { Id =  753  , Name ="Product Drawings", TagCategoryId =  15},
                        new Tag { Id =  754  , Name ="Specifications", TagCategoryId =  15},
                        new Tag { Id =  755  , Name ="Customer Drawings", TagCategoryId =  15},
                        new Tag { Id =  756  , Name ="Tool Drawings", TagCategoryId =  15},
                        new Tag { Id =  757  , Name ="Process Flow Diagram", TagCategoryId =  15},
                        new Tag { Id =  758  , Name ="Routers", TagCategoryId =  15},
                        new Tag { Id =  759  , Name ="Process Documentation", TagCategoryId =  15},
                        //Stage 4
                        new Tag { Id =  760  , Name ="FAI Approval", TagCategoryId =  15},
                        new Tag { Id =  761  , Name ="MSA", TagCategoryId =  15},
                        new Tag { Id =  762  , Name ="FAI", TagCategoryId =  15},
                });
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.Tags ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.Tags OFF");
                    #endregion

                    #region Insert StageConfig
                    _context.StageConfigs.AddRange(new StageConfig()
                    {
                        Id = 1,
                        StageNumber = 1,
                    ...
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.StageConfigs ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.StageConfigs OFF");
                    #endregion

                    #region Insert StageConfig_RequiredSchedules
                    _context.StageConfig_RequiredSchedules.AddRange(new List<StageConfig_RequiredSchedule>()
                    {
                    ...
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.StageConfig_RequiredSchedules ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.StageConfig_RequiredSchedules OFF");
                    #endregion

                    #region Insert GateConfigs
                    _context.GateConfigs.AddRange(new List<GateConfig>()
                    {
                        new GateConfig()
                        {
                            Id=1,
                    ...
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.GateConfigs ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.GateConfigs OFF");
                    #endregion

                    #region Insert GateKeeperConfigs
                    _context.GateKeeperConfigs.AddRange(new List<GateKeeperConfig>()
                    {
                    ...
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.GateKeeperConfigs ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.GateKeeperConfigs OFF");
                    #endregion
                    ...
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.Roles ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.Roles OFF");
                    #endregion
                    ...
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.Users ON;");
                    _context.SaveChanges();
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.Users OFF");
                    #endregion

                    #region Insert UserCitizenShip
                    _context.UserCitizenShip.AddRange(new List<User_CitizenShip>()
                    {
                    ...
                    _context.Database.ExecuteSqlInterpolated($"SET IDENTITY_INSERT dbo.UserCitizenShip ON;");
                    _context.SaveChanges();
            ...
            //}
            //if (_context.SeedDataMigrationVersions.Find(1).Version == 1)
            //{
            //    //Increment Version and Go on
            //    //using (var transaction = _context.Database.BeginTransaction())
            //    //{
            //    //    #region Increment Version
            //    //    var version = _context.SeedDataMigrationVersions.Find(1);
            //    //    version.Version = 2;
            //    //    _context.SeedDataMigrationVersions.Update(version);
            //    //    _context.SaveChanges();
            //    //    #endregion
